...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/003_losses.ipynb.
...
# %% ../nbs/003_losses.ipynb #d31a7ced
@add_method(CrossEntropyLoss)
def activation(self, x):
    return F.softmax(x, dim=1)

# %% ../nbs/003_losses.ipynb #e6e9dbda
