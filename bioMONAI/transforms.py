    ...
    def before_call(self, b:BioImageBase, split_idx=0):
        ...
        for out_key, spec in self._rand_kwargs.items():
            ...
            if isinstance(spec, str):
                ...
                self.sampled_kwargs[out_key] = self.param_sampler(raw)
            ...
            # -----------------------------------------
                ...
                self.sampled_kwargs[out_key] = tuple(
                    self.param_sampler(v) for v in raw_vals
                )
...
class RandCrop(RandMonaiTransform):
    ...
    has_channels : bool
        If True, the first dimension is treated as channels and not cropped.
