...
# %% auto #0
__all__ = ['FunctionTransform', 'MonaiTransform', 'Resample', 'Resize', 'CropND', 'RandCameraNoise', 'Blur', 'ScaleIntensity',
...
class FunctionTransform(Transform):
    """
    Generic wrapper to apply any NumPy or SciPy function to an image.
...
class MonaiTransform(Transform):
    """
    Generic wrapper for MONAI transforms (non-dictionary versions).

    This wrapper allows MONAI transforms to be used within the BioImage
    ...
    def __init__(self,
        ...
        """
        Initializes the MONAI transform wrapper.
