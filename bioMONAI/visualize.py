...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/110_visualize.ipynb.
...
# =================================
from .utils import *
from .datasets import cells3d

# %% ../nbs/110_visualize.ipynb #4273c3de
...
# %% ../nbs/110_visualize.ipynb #501a869c
...
# %% ../nbs/110_visualize.ipynb #4e79058f
...
# %% ../nbs/110_visualize.ipynb #92ed68f5
...
# %% ../nbs/110_visualize.ipynb #0078d8cd
...
# %% ../nbs/110_visualize.ipynb #5e7e936b
@delegates(go.Figure)
...
# %% ../nbs/110_visualize.ipynb #4a9ae857
def show_biodata(
    data,
    channel_threshold=4,
    max_slices=3,
...
# %% ../nbs/110_visualize.ipynb #362e7518
...
# %% ../nbs/110_visualize.ipynb #a6845bd1
colorlist = [
            'dimgray', 'firebrick', 'goldenrod', 'teal',
            '#102e42', 'darkslateblue', '#1c5175',
            'cadetblue', 'steelblue'
        ]

# %% ../nbs/110_visualize.ipynb #b881dfa8
biomonai_style = {
...
# %% ../nbs/110_visualize.ipynb #c9528154
def plot_metrics(
    learn,
    style=biomonai_style,
    **subplots_kwargs
):
    """
    Plot losses and metrics from a fastai Recorder.
...
# %% ../nbs/110_visualize.ipynb #74d544d6
def plot_intensity_histogram(
    ...
    **subplots_kwargs
    ...
    color : str
        Histogram color for grayscale/combined mode.
    ...
    with ctx:
        ...
        def filter_values(values):
            ...
            if mode == "greater":
                ...
                raise ValueError(
                    "mode must be None, 'greater', or 'lower'"
                )
        ...
        # ---- RGB ----
            ...
            if per_channel:
                ...
                ax.set_title(
                    "RGB Intensity Histogram (Per Channel)"
                )
                ...
                ax.set_title(
                    "RGB Combined Intensity Histogram"
                )
...
# %% ../nbs/110_visualize.ipynb #f1df3e7d
def plot_histogram_and_kde(
    ...
    **subplots_kwargs
    ...
    """
    Plot histogram and KDE with key statistics marked.
    ...
    bw_method : float or str
        Bandwidth method for gaussian_kde.

    fn_name : str
        Optional subtitle/title suffix.
    ...
    **subplots_kwargs
    ...
    with ctx:
        ...
        ax.axvline(
            ...
            linestyle='--',
            linewidth=1.5,
            label=f'Mean: {format_sig(stats["Mean"])}'
        )
        ...
        ax.axvline(
            ...
            linestyle='--',
            linewidth=1.5,
            label=f'Median: {format_sig(stats["Median"])}'
        )
        ...
        ax.axvline(
            ...
            linestyle=':',
            linewidth=1.5,
            label=f'Q1: {format_sig(stats["Q1"])}'
        )
        ...
        ax.axvline(
            ...
            linestyle=':',
            linewidth=1.5,
            label=f'Q3: {format_sig(stats["Q3"])}'
        )

        # ---- Text annotations ----

        ax.text(
            stats["Mean"] + stats["Standard Deviation"],
            0.1,
            f'Std Dev: {format_sig(stats["Standard Deviation"])}',
            color='black',
            fontsize=10
        )
        ...
        ax.set_title(
            f"Combined Histogram and KDE with Statistics\n{fn_name}"
        )
...
# %% ../nbs/110_visualize.ipynb #9389adbb
...
# %% ../nbs/110_visualize.ipynb #5b42d2c4
def plot_dist(
    values,
    marginal="box",
    nbins=None,
    ...
    if color is not None:
        if isinstance(color, str):
            ...
            if len(colors) < len(dists):
                raise ValueError("`color` must be a string or a list with at least one color per distribution.")
